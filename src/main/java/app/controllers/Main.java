...
public class Main implements Initializable {
    ...
    @FXML
    Label nor, date, os,arch, pid, ip, internet;
    @FXML
    JFXProgressBar pb;
    @FXML
    StackPane rootPane;
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                Platform.runLater(() -> {
                    ...
                    content.setBody(new Text("host: "+HibernateConfig.host+"\nport: "+HibernateConfig.port+(bName.equals("Apply")?"\nThis configuration is not valid and will not be applied":"")));
                    dialog.show();
    ...
    public void setGP(ActionEvent e) {
        ...
        switch(bName) {
            ...
            case "Order lines":
                ...
                new ZoomInUp(orderLinesGP).play();
                break;
            case "Products":
                if(nor.getOpacity()>0.0) {
                    new FlipOutX(nor).play();
