package app.tray.notification;


import app.Main;
import app.tray.animations.AnimationProvider;
import app.tray.animations.AnimationType;
import app.tray.animations.SlideAnimation;
import app.tray.animations.TrayAnimation;
import app.tray.models.CustomStage;
...
public final class TrayNotification {
    ...
    private void initTrayNotification(String title, String message, NotificationType type) {
        ...
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/app/tray/TrayNotification.fxml"));
    ...
    private void initAnimations() {
       ...
       animationProvider =
                new AnimationProvider(new SlideAnimation(stage));
    ...
    private void initStage() {
        ...
        s.setOnMouseClicked(e-> {
            dismiss();
            if(!(e.getTarget() instanceof SVGGlyph))
    ...
    public void setNotificationType(NotificationType nType) {
        ...
        switch (nType) {
            ...
            case INFORMATION:
                imageLocation = getClass().getResource("/app/tray/img/icons8-approval-64.png");
                paintHex = "#2C54AB";
                break;
            ...
            case SUCCESS:
                imageLocation = getClass().getResource("/app/tray/img/icons8-approval-48.png");
                paintHex = "#5E9C76";
                break;

            case WARNING:
                imageLocation = getClass().getResource("/app/tray/img/icons8-error-48.png");
                paintHex = "#E23E0A";
                break;

            case ERROR:
                imageLocation = getClass().getResource("/app/tray/img/icons8-error-64.png");
                paintHex = "#CC0033";
                break;
